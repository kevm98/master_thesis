...
from rrlab_tasks.manager_based.manipulation.obstacle_avoidance.envs.terrains import CustomTerrainImporter
...
@configclass
class CustomTerrainImporterCfg(TerrainImporterCfg):
    """Configuration for the terrain manager."""

    class_type: type = CustomTerrainImporter
