...
It renames all the occurrences of rrlab_tasks (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the rrlab_tasks folder
        os.rename(
            os.path.join(root_dir_path, "extensions", "rrlab_tasks", "rrlab_tasks"),
            os.path.join(root_dir_path, "extensions", "rrlab_tasks", new_name),
        )
        os.rename(os.path.join(root_dir_path, "extensions", "rrlab_tasks"), os.path.join(root_dir_path, "extensions", new_name))
