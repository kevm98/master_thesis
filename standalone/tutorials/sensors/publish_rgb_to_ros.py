...
.. code-block:: bash
    ...
    # Usage
    ./rrlab.sh -p standalone/tutorials/sensors/publish_rgb_to_ros.py --num_envs 1 --enable_camera
...
from omni.isaac.lab.utils.math import quat_from_euler_xyz, quat_mul, matrix_from_quat
from omni.isaac.lab.sensors import CameraCfg, TiledCameraCfg

##
# Pre-defined configs
##
from rrlab_assets import SAUGBAGGER_CFG
...
class TableTopSceneCfg(InteractiveSceneCfg):
    ...
    ground = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(0.0, 0.0, -1.05)), # ground is blew 0
    )
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        # Publish to ROS2
        camera_publisher.publish_image(rgb_images)
